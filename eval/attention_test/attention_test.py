...
from models.attention.attention import SleepAttentionNet
...
MODEL_PATH = os.path.join(RESULT_DIR, "best_attention.pth")
...
# LOAD MODEL
# =====================================================
model = SleepAttentionNet().to(DEVICE)
...
with open(os.path.join(RESULT_DIR, "n1_focus_report.txt"), "w") as f:
    f.write("N1 PERFORMANCE (Attention Model)\n")
    f.write("================================\n\n")
...
with open(os.path.join(RESULT_DIR, "results_readme.txt"), "w") as f:
    f.write("ATTENTION MODEL RESULTS\n")
    f.write("=======================\n\n")
...
print("\nSaved Files in results/attention/")
