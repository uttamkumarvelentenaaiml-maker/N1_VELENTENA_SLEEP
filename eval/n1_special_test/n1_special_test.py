# =====================================================
# FILE: eval/n1_special_test/n1_special_test.py
# TEST STRONG N1 MODEL
# Saves full research outputs
# =====================================================
...
from models.n1_special.n1_special import StrongN1Net

# =====================================================
# CONFIG
# =====================================================
DATA_PATH = "data/processed_sleep_edf"
RESULT_DIR = "results/n1_special"
MODEL_PATH = os.path.join(RESULT_DIR, "best_n1_special.pth")
...
plt.title("N1-Special Model Confusion Matrix")
plt.tight_layout()
...
with open(os.path.join(RESULT_DIR, "n1_focus_report.txt"), "w") as f:
    f.write("N1 PERFORMANCE (N1-SPECIAL MODEL)\n")
    f.write("=================================\n\n")
...
with open(os.path.join(RESULT_DIR, "results_readme.txt"), "w") as f:
    f.write("N1-SPECIAL MODEL RESULTS\n")
    f.write("========================\n\n")
    f.write(f"Accuracy     : {acc*100:.2f}%\n")
    f.write(f"Macro F1     : {macro_f1*100:.2f}%\n")
    f.write(f"Weighted F1  : {weighted_f1*100:.2f}%\n\n")
    f.write(f"N1 Precision : {n1_precision*100:.2f}%\n")
    f.write(f"N1 Recall    : {n1_recall*100:.2f}%\n")
    f.write(f"N1 F1        : {n1_f1*100:.2f}%\n")
...
print("\nSaved Files in results/n1_special/")
