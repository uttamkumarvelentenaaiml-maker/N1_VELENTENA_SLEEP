# =====================================================
# FILE: eval/n1_special_test/n1_v2_test.py
# TEST N1 SPECIAL V2
# Saves outputs in results/n1_special/v2/
# =====================================================
...
MODEL_PATH = os.path.join(RESULT_DIR, "best_n1_v2.pth")
...
plt.title("N1 V2 Confusion Matrix")
plt.tight_layout()
...
print("\nSaved Files in results/n1_special/v2/")
