...
from models.transformer.transformer import SleepTransformer
...
MODEL_PATH = os.path.join(RESULT_DIR, "best_transformer.pth")
...
with open(os.path.join(RESULT_DIR, "n1_focus_report.txt"), "w") as f:
    f.write("N1 PERFORMANCE (Transformer)\n")
    f.write("============================\n\n")
...
print("\nSaved Files in results/transformer/")
