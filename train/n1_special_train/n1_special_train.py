# =====================================================
# FILE: train/n1_special_train/n1_special_train.py
# STRONG N1 MODEL TRAINING (10 EPOCHS)
# Weighted Loss for N1 Focus
# =====================================================
...
# Class weights: Wake, N1, N2, N3, REM
# N1 gets highest weight
weights = torch.tensor([1.0, 3.0, 1.0, 1.2, 1.2], device=DEVICE)
...
for epoch in range(EPOCHS):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(
            model.state_dict(),
            os.path.join(RESULT_DIR, "best_n1_special.pth")
        )
